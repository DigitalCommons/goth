...
ruby bin/goth ${TTLINPUTS[@]} -l en -t esstemplate.erb > essglobal-vocab_en.html
ruby bin/goth ${TTLINPUTS[@]} -l es -t esstemplate.erb > essglobal-vocab_es.html
ruby bin/goth ${TTLINPUTS[@]} -l pt -t esstemplate.erb > essglobal-vocab_pt.html
ruby bin/goth ${TTLINPUTS[@]} -l fr -t esstemplate.erb > essglobal-vocab_fr.html
ruby bin/goth ${TTLINPUTS[@]} -l it -t esstemplate.erb > essglobal-vocab_it.html
ruby bin/goth ${TTLINPUTS[@]} -l ko -t esstemplate.erb > essglobal-vocab_ko.html
